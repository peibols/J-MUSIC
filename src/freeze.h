...
class Freeze{
 ...
 public:
    ...
    void get_total_momentum(InitData *DATA, int number, double minpt, double maxpt, int yflag, double minrap, double maxrap, double total_mom[4]);
    void get_dNdpt_dist(InitData *DATA, int number, double minpt, double maxpt, int yflag, double minrap, double maxrap);
    void get_dNdeta_dist(InitData *DATA, int number, double minpt, double maxpt, int yflag, double minrap, double maxrap);
    void get_dNdphi_dist(InitData *DATA, int number, double minpt, double maxpt, int yflag, double minrap, double maxrap);
    ...
    void OutputIntegratedMedResDists( InitData *DATA, int yflag, double pT_min, double pT_max);
    void OutputIntegrated4Momentum( InitData *DATA, int yflag, double pT_min, double pT_max);
};
